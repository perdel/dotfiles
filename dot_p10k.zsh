...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=4
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%235F'   # green foreground
      local   modified='%235F'  # yellow foreground
      local  untracked='%235F'   # blue foreground
      local conflicted='%235F'  # red foreground
    else
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=235
  # Custom icon.
  # typeset -g POWERLEVEL9K_BACKGROUND_JOBS_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #################[ ranger: ranger shell (https://github.com/ranger/ranger) ]##################
  # Ranger shell color.
  typeset -g POWERLEVEL9K_RANGER_FOREGROUND=235
  # Custom icon.
  # typeset -g POWERLEVEL9K_RANGER_VISUAL_IDENTIFIER_EXPANSION='⭐'

  ###########################[ vim_shell: vim shell indicator (:sh) ]###########################
  # Vim shell indicator color.
  typeset -g POWERLEVEL9K_VIM_SHELL_FOREGROUND=235
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_FOREGROUND=235
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=235
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=235
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=235
